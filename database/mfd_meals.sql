INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('1', 'Vegan Italian Wedding Soup', 'Like a happy marriage, the flavors in this soup join together in perfect harmony. Traditional chicken stock is replaced by a rich veggie broth that is infused with the lip-smacking flavors of tangy leeks and licorice-scented fennel. Carrots and green beans get delightfully tender as they soak up the savory broth and lend their earthy sweetness to the dish. And while classic recipes usually feature some sort of pasta for extra heft, our healthy, veganized version swaps in nutrient-rich red beans to keep you satiated. But the star of any Italian wedding soup is the meatballs. These lentil-based balls are packed full of zesty seasonings and baked until they are crisp-on-the-outside and juicy-on-the-inside, making them perfect for both kids and adults. Plop as many as you want into each serving, and then sprinkle on some chopped parsley and cheesy nutritional yeast for a delicious finishing touch.
Tip: You will need 1 cup of cooked brown lentils to make the meatballs for this recipe. To prep ahead for that, cook 6 tablespoons dry brown lentils according to package directions; cool. Place in an airtight container and chill up to 3 days.', 
'1. Preheat oven to 375°F. In a food processor combine the first seven ingredients (through pepper). Add ¼ cup aquafaba. Cover and pulse until mixture holds together. Form mixture into 1-inch balls. Place balls on a rimmed baking sheet. Bake 15 minutes.
2. Meanwhile, in a large pot cook leeks, carrots, fennel, and garlic over medium 5 minutes, stirring occasionally and adding broth, 1 to 2 tablespoons at a time, as needed to prevent sticking. Add remaining broth, the green beans, and red beans. Increase heat to high. Bring to boiling; reduce heat. Cover and simmer 5 to 7 minutes or until vegetables are tender. Season with salt and additional black pepper.
3. To serve, place hot meatballs in bowls. Ladle soup over meatballs. Sprinkle with parsley and nutritional yeast.', 
'https://www.forksoverknives.com/wp-content/uploads/Italian-Wedding-Soup-with-Lentil-Meatballs-wordpress.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('2', 'Rice Vermicelli Bowls with Bok Choy and Adzuki Beans', 
'This scrumptious one-pot recipe is packed to the brim with fresh ingredients to create a soupy noodle dish that is similar to Vietnamese pho. A simple veggie broth is elevated with the addition of garlic, ginger, and crushed red pepper to really turn up the slurpability of the vermicelli noodles. Umami-rich enoki mushrooms and earthy bok choy get delightfully tender in the warm broth, while nutrient-dense tofu and slightly sweet adzuki beans add heft to the delicate noodles. If you are a fan of spicy food, add a drizzle of sriracha just before serving and enjoy!', 
...
Stir in miso paste. Turn off heat. 
2. Stir in noodles, mushrooms, and scallions. Let stand 3 to 5 minutes or until noodles are softened. Spoon into bowls and top with radishes, basil, and sesame seeds. If desired, serve with sriracha sauce.', 'https://www.forksoverknives.com/wp-content/uploads/fly-images/161476/Bok-Choy-Bean-Noodle-Bowls-wordpress-688x387-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('3', '30-Minute One-Pot Pesto Pasta', 
...
'https://www.forksoverknives.com/wp-content/uploads/fly-images/160538/One-Pot-Pesto-Pasta-wordpress-670x377-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('4', 'Creamy One-Pot Pasta with Broccolini', 
...
'https://www.forksoverknives.com/wp-content/uploads/fly-images/158368/One-Pan-Creamy-Pasta-with-Broccolini-wordpress-670x377-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('5', 'Vegan Minestrone Soup with Potatoes and Kale', 
...
'https://www.forksoverknives.com/wp-content/uploads/fly-images/150037/potato-kale-minestrone-wordpress-688x387-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('6', 'Harvest Vegetable Instant Pot Minestrone', 
...
'https://www.forksoverknives.com/wp-content/uploads/fly-images/98323/Harvest-Vegetable-Minestrone-for-wordpress-688x387-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('7', 'One-Pot Squash and Brussels Sprouts Panzanella with Dried Cherries',
...
4. Serve immediately.',
'https://www.forksoverknives.com/wp-content/uploads/fly-images/28643/Calabaza-Panzanella-023small-688x387-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('8', 'Penne with Butternut Squash and Fressh Fennel', 
...
'https://www.forksoverknives.com/wp-content/uploads/fly-images/159471/Penne-with-Butternut-Squash-and-Fresh-Fennel-wordpress-688x387-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('9', 'Breakfast Scramble', 
...
'https://www.forksoverknives.com/wp-content/uploads/fly-images/24262/Breakfast-Scramble-WP-670x377-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('10', 'Vegan Soba Noodle Salad',
...
'https://www.forksoverknives.com/wp-content/uploads/fly-images/158300/Soba-Noodle-Salad-wordpress-670x377-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('11', 'Root-to-Leaf Radish Pasta',
...
'https://www.forksoverknives.com/wp-content/uploads/fly-images/152802/rotini-pasta-leeks-wordpress-670x377-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('13', 'Sorghum Berry Breakfast Bowl', 
'Cook up a batch of sorghum to enjoy in salads, soups and freestyle bowls, and use some of it for this very tasty vegan breakfast bowl recipe. With its mild, slightly nutty flavor that is reminiscent of wheat berries, sorghum is a great grain to try if you do not eat gluten.',
...
'https://www.forksoverknives.com/wp-content/uploads/fly-images/56587/Sorghum-Berry-Breakfast-Bowls_WP-670x377-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('14', 'Linguine with Root Vegetable Ribbons', 
...
'https://www.forksoverknives.com/wp-content/uploads/fly-images/117063/linguine-root-vegetable-ribbons-wordpress-scaled-670x377-c.jpg')

INSERT INTO mfd_recipes (recipe_id, recipe_name, recipe_description, recipe_instructions, recipe_image_link) 
VALUES ('15', 'Herbed Breakfast Hash',
'Hash is a great dish for using up leftover veggies in your fridge that you do not know what to do with. Seasoned with fragrant garlic, smoky chili powder, and lots of fresh herbs, this recipe is a  hearty and healthy way to start your day. Serve it with a side of whole grain toast and a scoop of homemade vegan yogurt, and you have got a breakfast of champions!
...
'https://www.forksoverknives.com/wp-content/uploads/fly-images/158221/herbed-breakfast-hash-wordpress-670x377-c.jpg')